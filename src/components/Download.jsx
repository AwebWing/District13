  ...
  return (
    <section id="download" ref={ref} className="relative bg-[var(--bg)] overflow-hidden">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at center, rgba(232, 28, 28, 0.15) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <div className="w-24 h-1 bg-[var(--red)] mx-auto mb-8" />
        </motion.div>
        ...
        >
          {[
            ...
            <motion.div
              key={req.label}
              className="flex items-center gap-4 p-4 bg-[var(--surface)] border-l-2 border-[var(--red)]/50"
              whileHover={{ borderLeftColor: 'var(--red)', x: 8 }}
              transition={{ duration: 0.2 }}
            >
              <span className="font-heading text-xl text-[var(--red)] min-w-[100px]">
                {req.label}
              </span>
        ...
        >
          <div className="bg-[#0d0d0d] border border-[#333] rounded-lg overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-[#1a1a1a] border-b border-[#333]">
              ...
              <span className="font-mono text-xs text-[var(--white)]/50">terminal</span>
            </div>
        ...
        >
          <motion.a
            href="game.zip"
            className="inline-block px-12 py-5 bg-[var(--red)] font-heading text-2xl tracking-wider text-white pulse-glow"
            whileHover={{ scale: 1.05, boxShadow: '0 0 60px rgba(232, 28, 28, 1)' }}
            whileTap={{ scale: 0.97 }}
        ...
        >
          <motion.a
            href="#"
            className="inline-flex items-center gap-2 font-body text-[var(--white)]/70 hover:text-[var(--red)] transition-colors"
            whileHover={{ x: 4 }}
          ...
          >
            ...
            <span className="underline decoration-transparent hover:decoration-[var(--red)] underline-offset-4">
